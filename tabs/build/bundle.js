...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tabs = _react2['default'].createClass({
	    ...
	    getInitialState: function getInitialState() {
	        var defaultActiveIndex = this.props.defaultActiveIndex || 1;
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            'div',
	            { 'data-am-widget': 'tabs', className: 'am-tabs am-tabs-default am-no-layout' },
	    ...
	    renderTabsHeader: function renderTabsHeader() {
	        var _this = this;
	        ...
	        if (this.props.data) {
	            ...
	            return this.props.data.map(function (item, index) {
	                return _this.renderTabsHeaderInner(item, index);
	            });
	        } else {

	            return _react2['default'].Children.map(this.props.children, function (child) {
	                if (child && child.type.displayName === 'TabPane') {
	                    return _this.renderTabsHeaderInner(child, innerIndex++);
	                }
	            });
	        }
	    },

	    renderTabsHeaderInner: function renderTabsHeaderInner(item, index) {
	        return _react2['default'].createElement(
	            'li',
	            { onClick: this.switchTab.bind(null, index + 1),
	                key: index,
	                className: _classnames2['default']({ 'am-active': this.state.activeIndex === index + 1 }) },
	            _react2['default'].createElement(
	                'a',
	                { href: 'javascript:;' },
	                _react2['default'].isValidElement(item) ? item.props.tab : item.title
	            )
	        );
	    },

	    renderTabsContent: function renderTabsContent() {
	        var _this2 = this;
	        ...
	        if (this.props.data) {
	            ...
	            return this.props.data.map(function (item, index) {
	                return _this2.renderTabsContentInner(item, index);
	            });
	        } else {
	            return _react2['default'].Children.map(this.props.children, function (child) {
	                if (child && child.type.displayName === 'TabPane') {
	                    return _this2.renderTabsContentInner(child, innerIndex++);
	                }
	            });
	        }
	    },

	    renderTabsContentInner: function renderTabsContentInner(item, index) {

	        if (!_react2['default'].isValidElement(item)) {
	            item = _react2['default'].createElement(_TabPane2['default'], {}, item.content);
	        }
